...
public class ItemPlantSeeds extends Item implements IPlantable {
	    ...
	    public ItemPlantSeeds(int i, Block p_i45352_1_, Block p_i45352_2_)
	    {
	        this.field_150925_a = p_i45352_1_;
	        this.soilBlockID = p_i45352_2_;
	        this.setCreativeTab(MoreStuff.TabMoreStuff);
	        this.setUnlocalizedName("PlantSeeds");
	    }
