...
public class ItemJumpC extends Item {
	
	public ItemJumpC(int i){
		
		
		super();                        
		this.setHasSubtypes(true);                        
		this.setMaxDamage(8);
		this.setUnlocalizedName("JumpC");
		this.setCreativeTab(MoreStuff.TabMoreStuff);
		
		this.setTextureName(Strings.MODID + ":" + "JumpC");
		}
		...
		public ItemStack onItemRightClick(ItemStack item, World w, EntityPlayer e){
			...
			if(!w.isRemote)	
			{
				...
				item.damageItem(1, e);
				e.addPotionEffect(new PotionEffect(Potion.jump.id, 5 * 100, 1, true));
			}
