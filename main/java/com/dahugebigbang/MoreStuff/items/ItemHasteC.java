...
public class ItemHasteC extends Item {
	
	
	public ItemHasteC(int i){
		
		
		super();                        
		this.setHasSubtypes(true);                        
		this.setMaxDamage(8);
		this.setUnlocalizedName("HasteC");
		this.setCreativeTab(MoreStuff.TabMoreStuff);
		
		this.setTextureName(Strings.MODID + ":" + "HasteC");
		}
		...
		public ItemStack onItemRightClick(ItemStack item, World w, EntityPlayer e){
			...
			if(!w.isRemote)	
			{
				...
				item.damageItem(1, e);
				e.addPotionEffect(new PotionEffect(Potion.digSpeed.id, 5 * 100, 1, true));
			}
