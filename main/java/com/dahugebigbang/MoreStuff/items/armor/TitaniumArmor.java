...
public class TitaniumArmor extends ItemArmor {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
		if(stack.getItem() == MoreStuff.TitaniumHelmet || stack.getItem() == MoreStuff.TitaniumChestplate || stack.getItem() == MoreStuff.TitaniumBoots)   {
			return "MoreStuff:textures/models/armor/TitaniumArmor_1.png";
		}
		if(stack.getItem() == MoreStuff.TitaniumLeggings) {
